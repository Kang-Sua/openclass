...
# --- 화면 5: 나누려는 마음을 담아 글을 써 보세요. ---
    ...
    with col_hints:
        ...
        st.markdown("<div style='height: 60px;'></div>", unsafe_allow_html=True) # "받는이에게" 줄과 "첫인사" 힌트 간격
        ...
        st.markdown("<div style='height: 30px;'></div>", unsafe_allow_html=True) # 이전 text_area 높이 (80px)를 반영하여 다음 힌트 위치 조정
        ...
        st.markdown("<div style='height: 20px;'></div>", unsafe_allow_html=True) # 이전 text_area 높이 (80px)를 반영하여 다음 힌트 위치 조정
